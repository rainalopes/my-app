    ...
    <Navbar dark expand="md">
      <div className="container">
        ...
        <NavbarBrand className="mr-auto" href="/">
            <img src="assets/images/logo.png" height="30" width="41" alt="Food blog"/>
        </NavbarBrand>
        ...
        <div className="container">
            <div className="row row-header">
                <div className="col-12 col-sm-6">
                    <h1>Raina's Food Blog</h1>
                    <p> Worlds best food blog!!Mammmamiyaaaaaaa....Come and devour cuisines from worldwide</p>
                </div>
            </div>
        </div>
    </Jumbotron>
